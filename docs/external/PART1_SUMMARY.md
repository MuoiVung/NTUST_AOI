...
## 系統架構圖
![image](https://hackmd.io/_uploads/By0Jh5-gMx.png)
...
根據板子的寬度調整輸送帶寬度後，將板子放上進板區域的突起塊上，於HMI主畫面按下自動啟動按鈕，機台將會啟動輸送帶運轉將進板區的板子送入檢測區中，待板子完全於檢測區停止後，上下方XY table自動移動並進行拍照，圖片將會
